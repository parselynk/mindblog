...
@section('content')
	<header class="flex items-center mb-3 py-4">
		<div class="flex justify-between items-end w-full">
			...
			<a href="/admin/articles/create" class="button">New Article</a>
		</div>
	</header>
			...
			<div class="w-full px-3 pb-6">
				<div class="card lg:flex items-start flex-shrink lg:overflow-hidden" style="min-height:250px" >
					<div class="{{ $article->photos->count() ? 'lg:w-3/4' : 'w-full'}} px-3 mb-6  flex-shrink">
						<h3 class="font-normal text-xl -ml-8 mb-3 py-4 border-l-4 border-blue-light pl-6"><a href="{{ $article->adminPath() }}" class="text-black no-underline">{{ $article->title }}</a></h3>
						<div class="text-grey">
